...
- **Context continuity**: pre/post compact hooks capture and restore the active
  work state instead of relying on chat memory.
...
- **Skill activation**: coder, thinker and plugin skills give the agent
  specialized behavior without one opaque prompt.
...
but the portfolio should send reviewers to d-nd-seed first because it is active,
...
Needs a selected screenshot/diagram pass for the future public site page, but it
